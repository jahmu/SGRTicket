    ...
    companion object {
        class SignUpAsyncTask internal constructor(context: Context) : AsyncTask<String, String, String>() {
            ...
            override fun onPreExecute() {
                super.onPreExecute()
                val name: String = binding.insertName.text.toString()
                val phoneNumber: String = binding.insertPhoneNumber.text.toString()
                val password: String = binding.insertPassword.text.toString()
            ...
            override fun doInBackground(vararg params: String?):  String? {
                try {
                    ...
                    val url: String = "http://sgrticket96.000webhostapp.com/sgrApp/create.php"
                    val obj = URL(url)
